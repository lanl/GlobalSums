...
globalsums: globalsums.o do_sum.o do_sum_wdigittrunc.o do_sum_wbittrunc.o do_ldsum.o do_ldsum_wdigittrunc.o do_ldsum_wbittrunc.o \
            do_kahan_sum.o do_kahan_sum_v.o do_kahan_sum_gcc_v.o do_knuth_sum.o do_knuth_sum_v.o do_pair_sum.o do_qdsum.o \
            do_qdsum_wtrunc.o do_full_qdsum.o do_full_qdsum_wtrunc.o do_sum_omp.o do_sum_omp_wbittrunc.o do_kahan_sum_omp.o \
            do_kahan_sum_omp_wbittrunc.o kahan_agner_vector.o
